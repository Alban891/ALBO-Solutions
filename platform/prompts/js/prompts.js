...
class PromptsEngine {
    ...
    "Bilanzbuchhalter": {
                ...
                "themes": [
                    ...
                    {"id": "allgemeine_ansatz", "name": "⚖️ Allgemeine Ansatzregeln", "keywords": ["Aktivierungsfähigkeit nach HGB – abstrakt", "Aktivierungsverbot nach § 248", "Aktivierungswahlrechte – Entwicklungskosten", "Aktivierungsgebote bei Nicht-Vermögensgegenständen – z.B. RAP", "Zurechnung von Vermögensgegenständen – wirtschaftliches", "Passivierungsfähigkeit – Drei Kriterien für Schulden", "Abgrenzung: Rückstellung oder Eventualverbindlichkeit", "Ansatzgrundsätze in der Steuerbilanz – Maßgeblichkeitsprinzip", "Ansatzvorschriften nach IFRS – Unterschiede"]},
                    {"id": "allgemeine_bewertung", "name": "💰 Allgemeine Bewertungsregeln", "keywords": ["Grundprinzipien der Bewertung – Überblick & GoB", "Zugangsbewertung von Vermögensgegenständen – Anschaffung, Herstellung", "Folgebewertung – Niederstwertprinzip und Zuschreibungspflicht", "Bewertung von Schulden – Erfüllungsbetrag und Rückstellungen", "Bewertungsvereinfachungsverfahren – FIFO, LIFO", "Bewertungseinheiten und Sicherungsbeziehungen – § 254 HGB", "Währungsumrechnung bei Bilanzansatz – § 256a HGB", "IFRS-Bewertungskonzepte im Vergleich – Fair Value", "Wertaufhellung vs. Wertbegründung – Bilanzstichtagsprinzip"]},
                    {"id": "anlagevermoegen", "name": "🏭 Bilanzierung des Anlagevermögens", "keywords": ["Aktivierung von Sachanlagen – Anschaffungsnebenkosten", "Nachträgliche Anschaffungskosten", "Erweiterungen und Erneuerungen an Anlagen", "Abgrenzung aktivierungspflichtiger, -fähiger und -verbotener", "Aktivierung selbst erstellter immaterieller Vermögenswerte", "Abgrenzung Anlagevermögen vs. Umlaufvermögen", "Zurechnung von Wirtschaftsgütern bei abweichender", "Bilanzierung von Anlagen im Bau", "Bilanzierung geringwertiger Wirtschaftsgüter", "Originärer Geschäfts- oder Firmenwert"]},
                    {"id": "vorratsvermoegen", "name": "📦 Bilanzierung des Vorratsvermögens", "keywords": ["Definition & Abgrenzung: Was gehört zum Vorratsvermögen", "Zugangsbewertung von Vorräten gemäß § 255", "Folgebewertung von Vorräten nach dem Niederstwertprinzip § 253", "Bewertungsvereinfachungsverfahren bei Vorräten", "Teilwertabschreibung bei Vorräten – steuerliche Bewertung", "Bewertung von Roh-, Hilfs- und Betriebsstoffen", "Bewertung unfertiger Erzeugnisse – Herstellungskosten", "Bewertung fertiger Erzeugnisse – Niederstwertprinzip", "Bewertung von Handelswaren – Strenges Niederstwertprinzip", "Bewertung des Vorratsvermögens nach IFRS"]},
                    {"id": "forderungen", "name": "📄 Bilanzierung der Forderungen", "keywords": ["Bilanzierung von Forderungen aus Lieferungen und Leistungen", "Zweifelhafte Forderungen: Teilwertabschreibung und Pauschalwertberichtigung", "Pauschalwertberichtigung auf Forderungen nach HGB", "Bilanzierung uneinbringlicher Forderungen – Vollwertabschreibung", "Pauschalwertberichtigung auf Forderungen – Einzel-", "Umsatzsteuerliche Korrekturen bei uneinbringlichen Forderungen § 17 UStG", "Bilanzierung von Forderungen nach IFRS – Klassifikation", "Bilanzierung nach IFRS 9 – Expected Credit Loss"]},
                    {"id": "finanzinstrumente", "name": "💼 Bilanzierungen von Finanzinstrumenten", "keywords": ["Klassifizierung von Finanzinstrumenten (HGB)", "Bewertung börsennotierter Wertpapiere (Umlaufvermögen, HGB)", "Bilanzierung nicht börsennotierter Beteiligungen (Finanzanlagevermögen", "Zuschreibungen bei Wertaufholung (§ 253 Abs. 5 HGB)", "Abgrenzung derivativer Finanzinstrumente (z.B. Optionen, Swaps", "Hedging & Bewertung von Sicherungsgeschäften nach HGB", "Verkauf und Ausbuchung von Finanzinstrumenten (HGB)", "Bilanzierung von Finanzinstrumenten bei Kreditinstituten (RechKredV)", "Vergleich HGB vs. IFRS bei der Bilanzierung von Finanzinstrumenten", "Vergleich HGB vs. US GAAP bei der Bilanzierung von Finanzinstrumenten"]},
                    {"id": "eigenkapital", "name": "💎 Bilanzierung des Eigenkapitals", "keywords": ["Funktion, Gliederung und Bedeutung des Eigenkapitals nach HGB", "Bilanzierung des gezeichneten Kapitals (Zugang, Bewertung", "Ausstehende Einlagen auf das gezeichnete Kapital nach § 272", "Kapitalerhöhung – Bilanzierung des gezeichneten Kapitals", "Kapitalherabsetzung – Bilanzielle Behandlung und Ausweis", "Kapitalzuschuss nach § 272 Abs. 2 HGB", "Gewinnrücklagen nach § 272 Abs. 3-5 HGB", "Gewinn-/Verlustvortrag – Bilanzierung und Ausweis", "Jahresüberschuss / Jahresfehlbetrag – Ausweis", "Sonder- & Ergänzungskapitalkonten bei Personengesellschaften", "Inkongruente Gewinnausschüttung – Steuerlich zulässige", "Disquotalen Einzahlung in die Kapitalrücklage bei GmbHs"]},
                    {"id": "verbindlichkeiten", "name": "🔗 Bilanzierung von Verbindlichkeiten", "keywords": ["Begriff und Arten von Verbindlichkeiten – Abgrenzung, Systematik", "Ansatz und Bewertung von Verbindlichkeiten – Grundsätze nach § 253", "Verbindlichkeiten mit Differenz zwischen Auszahlung und Rückzahlung", "Unverzinsliche Verbindlichkeiten aus Rentenverpflichtungen", "Verbindlichkeiten mit Skonto – Bewertung zum Erfüllungsbetrag", "Fremdwährungsverbindlichkeiten – Zugang, Umrechnung", "Bilanzierung von Verbindlichkeiten nach IFRS – Klassifikation", "Verbindlichkeiten nach US GAAP – Klassifikation", "Verbindlichkeiten im Vergleich – HGB, IFRS, US GAAP"]},
                    {"id": "rueckstellungen", "name": "📊 Bilanzierung der Rückstellungen", "keywords": ["Rückstellungen – Begriff, Zweck & Abgrenzung zu Verbindlichkeiten § 249", "Rückstellungen in der Steuerbilanz – Maßgeblichkeit", "Rückstellungen für ungewisse Verbindlichkeiten – Ansatz", "Rückstellungen für unterlassene Instandhaltung und Abraumbeseitigung", "Rückstellungen für Gewährleistungen ohne rechtliche Verpflichtungen", "Rückstellungen für Steuern", "Bewertung von Rückstellungen – Erfüllungsbetrag, Abzinsung § 253", "Bilanzierung von Drohverlustrückstellungen bei schwebenden Geschäften", "Rückstellungen für Pensionen und ähnliche Verpflichtungen", "Rückstellungen für Altersversorgungsverpflichtungen – BilMoG", "Anhangangaben zu Rückstellungen gemäß § 285 Nr. 12 HGB", "Rückstellungen nach IFRS (IAS 37) – Ansatz", "Rückstellungen nach US GAAP (ASC 450) – Contingencies", "Vergleich Rückstellungen HGB – IFRS – US GAAP", "Rückstellungen für Dienstjubiläen"]},
                    {"id": "besondere_posten", "name": "📌 Besondere Bilanzposten", "keywords": ["Begriff & Funktion von Rechnungsabgrenzungsposten § 250", "Active Rechnungsabgrenzungsposten – Voraussetzungen", "Passive Rechnungsabgrenzungsposten – Voraussetzungen", "Abgrenzung RAP zu Verbindlichkeiten & Rückstellungen", "Latente Steuern – Grundlagen & gesetzliche Vorgaben § 274", "Active latente Steuern – Ansatz, Bewertung", "Passive latente Steuern – Entstehung, Abgrenzung", "Latente Steuern im IFRS-Abschluss (IAS 12)", "Eventualverbindlichkeiten & Haftungsverhältnisse § 251", "Bürgschaften, Patronatserklärungen, Sicherheiten", "Angabepflichten bei nicht bilanzierungsfähigen Verpflichtungen"]},
                    {"id": "guv", "name": "📈 Gewinn- und Verlustrechnung", "keywords": ["Aufbau, Gliederung und Bedeutung der GuV nach § 275", "Gliederung der Gesamtkosten- und Umsatzkostenverfahren", "Umsatzerlöse nach § 277 Abs. 1 HGB und IFRS 15", "Bestandsveränderungen und aktivierte Eigenleistungen § 275", "Sonstige betriebliche Erträge & Aufwendungen", "Personalaufwand (§ 275 Abs. 2 Nr. 6 HGB)", "Abschreibungen auf immaterielle Vermögensgegenstände und Sachanlagen", "Erträge und Aufwendungen aus Beteiligungen, Wertpapieren", "Zinserträge und Zinsaufwendungen – handelsrechtlicher Ausweis", "Ergebnis aus Währungsumrechnung und Kurssicherung – GuV", "Außerordentliche Erträge & Aufwendungen – handelsrechtliche", "Jahresüberschuss und Bilanzgewinn – Ableitung", "Ergebnisverwendung im Einzelabschluss vs. Konzernabschluss"]},
                    {"id": "anhang", "name": "📝 Anhang", "keywords": ["Zweck, Funktion und Struktur des Anhangs (§§ 284–285 HGB)", "Bilanzierungs- und Bewertungsmethoden im Anhang § 284", "Verbindlichkeiten, Sicherheiten und Restlaufzeiten im Anhang § 285", "Anhangangaben zu Anteilseignern, Beteiligungen und Organen § 285", "Angaben zur Ergebnisverwendung und Ausschüttung im Anhang § 285", "Freiwillige Angaben & Best Practices im Anhang (z.B. ESG", "Größenabhängige Erleichterungen – Wegfasslisten nach § 288", "Haftungsverhältnisse & Eventualverbindlichkeiten § 251 HGB", "Nachtragsberichterstattung – Ereignisse nach dem Bilanzstichtag § 285", "Angaben zu Beteiligungen & Tochterunternehmen § 285 Nr. 11", "Exklusiv: Vollständiger Anhang"]},
                    {"id": "lagebericht", "name": "📄 Lagebericht", "keywords": ["Grundlagen des Lageberichts: Funktionen, Zielsetzung § 289", "Inhalt des Lageberichts: Pflichtbestandteile nach § 289", "Forschungs- und Entwicklungsaktivitäten im Lagebericht § 289", "Darstellung des Geschäftsverlaufs im Lagebericht § 289", "Prognose-, Chancen- und Risikobericht § 289 Abs. 1 S. 4", "Risikomanagementsystem & IKS im Lagebericht § 289 Abs. 4", "Darstellung der Vermögens-, Finanz- und Ertragslage (VFE-Lage)", "Darstellung der Ertragslage im Lagebericht gemäß § 289 HGB und DRS 20", "Nachtragsbericht im Lagebericht – Ereignisse nach dem Bilanzstichtag", "Finanzielle Leistungsindikatoren im Lagebericht § 289", "Nichtfinanzielle Leistungsindikatoren im Lagebericht § 289", "Erklärung zur Unternehmensführung § 289f HGB", "Gesamtbild und Vollständigkeitserklärung im Lagebericht"]},
                    {"id": "kapitalflussrechnung", "name": "💵 Kapitalflussrechnung", "keywords": ["Zweck und Rechtsgrundlagen der Kapitalflussrechnung nach HGB §§ 264", "Grundstruktur und Gliederung der Kapitalflussrechnung nach DRS 21", "Cashflow aus laufender Geschäftstätigkeit", "Cashflow aus Investitionstätigkeit", "Cashflow aus Finanzierungstätigkeit", "Ableitung der Kapitalflussrechnung aus Bilanz und GuV", "Definition & Abgrenzung Finanzmittelfonds", "Kapitalflussrechnung im Konzern", "Kapitalflussrechnung nach IFRS (IAS 7) – Pflichten", "Sonderfragen in der Kapitalflussrechnung – Leasing", "Prüfung und Plausibilisierung der Kapitalflussrechnung", "Erstellung einer vollständigen Kapitalflussrechnung durch die KI"]},
                ]
            },
    "Business Developer": {
        "icon": "🚀",
